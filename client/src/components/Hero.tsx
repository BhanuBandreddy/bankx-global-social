...
export const Hero = () => {
  ...
  return (
    <div className="relative bg-white neo-brutalist border-black transition-all duration-300 hover:shadow-lg" style={{ fontFamily: 'Roboto Mono, monospace' }}>
      {/* Neo-brutalist Background Elements */}
      <div className="absolute top-8 left-8 w-32 h-32 neo-brutalist bg-yellow-400 transform rotate-12 hidden md:block animate-pulse"></div>
      <div className="absolute bottom-8 right-8 w-20 h-20 neo-brutalist bg-blue-500 transform -rotate-12 hidden md:block animate-pulse"></div>

      <div className="relative container mx-auto px-4 py-20 text-center">
        <div className="max-w-5xl mx-auto">
          <h1 className="font-black text-black text-[clamp(2.2rem,5vw,4rem)] leading-tight mb-8 uppercase hover:text-gray-800 transition-colors duration-200" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '2px' }}>
            The Future of
            <br />
            <span className="neo-brutalist bg-lime-400 px-4 transform -skew-x-12 inline-block hover:bg-lime-500 transition-colors duration-200">
              Social Commerce
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
            <button className="neo-brutalist px-8 py-4 bg-black text-white font-black text-lg uppercase flex items-center justify-center space-x-3 hover:bg-gray-800 transition-colors duration-200" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '2px' }}>
              <span>JOIN THE REVOLUTION</span>
              <ArrowRight className="w-5 h-5" />
            </button>

            <button className="neo-brutalist px-8 py-4 bg-white text-black font-black text-lg uppercase hover:bg-gray-200 transition-colors duration-200" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '2px' }}>
              WATCH DEMO
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="group hover:rotate-[-2deg] transition-transform duration-150">
              <div className="neo-brutalist bg-white p-8 hover:shadow-md transition-shadow duration-200">
            ...
            <div className="group hover:rotate-[-2deg] transition-transform duration-150">
              <div className="neo-brutalist bg-gray-100 p-8 hover:shadow-md transition-shadow duration-200">
                <div className="w-16 h-16 neo-brutalist bg-black flex items-center justify-center mb-6 mx-auto transform rotate-12">
