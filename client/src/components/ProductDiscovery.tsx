...
const parisProducts: Product[] = [
  {
    ...
    coordinates: [2.5479, 49.0097], // CDG Airport coordinates
    price: "€200",
    priceInr: "₹18,160",
    rating: 4.9,
  ...
  },
  {
    ...
    coordinates: [2.3590, 48.8571], // Marais district
    price: "€12",
    priceInr: "₹1,090",
    rating: 4.7,
  ...
  },
  {
    ...
    coordinates: [2.3344, 48.8533], // Saint-Germain
    price: "€24",
    priceInr: "₹2,180",
    rating: 4.8,
  ...
  },
  {
    ...
    coordinates: [2.3317, 48.9014], // Flea market
    price: "€180",
    priceInr: "₹16,340",
    rating: 4.6,
...
export const ProductDiscovery = ({ onProductSelect }: ProductDiscoveryProps) => {
  ...
  const handleReserve = (product: Product) => {
    ...
    toast({
      ...
      description: `Perfect match found: ${product.name} - initiating TrustPay escrow`,
    });
  };
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="mt-6 p-4 bg-purple-50 border-4 border-purple-200">
          ...
          <p className="text-sm text-purple-700">
            ...
            Recommendations optimized for your Chennai→Paris route with live FX rates.
          </p>
        </div>
      </CardContent>
    </Card>
